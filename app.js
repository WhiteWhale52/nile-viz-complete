...
// Public base URL of the R2 bucket holding hierarchy/manifest JSON and
// Parquet files (mirrors what used to be the local "data/" folder).
// Fill in with your bucket's R2.dev URL or custom domain, e.g.
// "https://pub-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.r2.dev"
const R2_BASE_URL = "https://pub-74e2bc42e2c4456ca88bd23d66a5adc1.r2.dev";

// Builds an absolute R2 URL for a file/key that used to live under the
// local "data/" folder. Strips a leading "data/" if present so callers
// can pass either "hierarchy.json" or "data/hierarchy.json".
function r2Url(relativePath) {
...
const DATASET_CONFIGS = {
  basins: {
    hierarchy: r2Url("hierarchy_basins.json"),
    manifest: r2Url("climate_parquet_manifest_basins.json"),
  },
  countries: {
    hierarchy: r2Url("hierarchy_countries.json"),
    manifest: r2Url("climate_parquet_manifest_countries.json"),
  },
};
